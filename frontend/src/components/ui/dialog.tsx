...
const DialogHeader = ({
    ...
    <div
        className={cn(
            "flex min-w-0 flex-col space-y-1.5 pr-7 text-left",
            className
        )}
        {...props}
    />
